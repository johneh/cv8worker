const gLoader = $loadlib('./libgdk-pixbuf-loader.so');
const gPixbuf = $loadlib('./libgdk-pixbuf.so');
const _await = $loadlib('./libpixbuf-await.so').await;
const gObject = $loadlib('/libgobject.so');
const gCairo = $loadlib('./libgdk-cairo.so');
