...
$print(`
const GTYPES = module.__args[0];
const gtklib = module.__args[1];
const gtype_to_js = module.__args[2];
const GPROTO = GTYPES['${GOBJNAME}'];
`);
...
`;
            ...
            case TYPEDEFPTR:
                ...
                str += `  if (!GTYPES['${p.tagname}'].isPrototypeOf(${pname}))
