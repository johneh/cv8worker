...
exports.main_iteration_do = function () {
    if (!__done__)
        gtkb.main_iteration_do(false);
};
...
exports.GtkMenuBar = require('_gtkmenubar.js');

exports.GtkStatusbar = require('_gtkstatusbar.js');

//require('_gtktoolshell.js');  -- XXX: interface not needed???
exports.GtkToolItem = require('_gtktoolitem.js');
exports.GtkToolButton = require('_gtktoolbutton.js');
exports.GtkToolbar = require('_gtktoolbar.js');
