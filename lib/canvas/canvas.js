...
class Canvas {
    constructor(...args) {
        ...
        /*if (typeof args[0] === 'object' &&
                args[0].constructor.name === 'cairo_t') {
            this._surface = cairo.get_target(args[0]);
            cairo.surface_reference(this._surface); // increment ref. count
            this._type = cairo.get_surface_type(this._surface);
            this._context2d = new Context2d(this, args[0]);
        } else*/
    ...
    getContext(contextId) {
        if ('2d' === contextId && this._surface !== null) {
    ...
    _init(type, surface, width, height) {
        this._type = type;
